...
final class SessionManagerTests: XCTestCase {
    ...
    func testRenewSessionChangesId() {
        let original = manager.currentSessionId()
        manager.renewSession()
        let renewed = manager.currentSessionId()
    ...
    func testSessionRestoredFromStorage() {
        ...
        let restored = manager2.currentSessionId()
    ...
    func testExpiredSessionIsRenewed() {
        ...
        let originalId = manager.currentSessionId()
        ...
        let newId = expiredManager.currentSessionId()
